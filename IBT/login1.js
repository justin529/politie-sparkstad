...
async function checkLogin(event) {
    ...
    try {
        ...
        const response = await fetch('/afbeelding/A1/a3/a6/h/hah/Nieuwe map/s/afbeeldingen1.json');
        ...
        if (user) {
            ...
            window.location.href = '/IBT/ibt-home.html';  // Stuur de gebruiker door naar het dashboard
        } else {
